// Icons.jsx - Create this file in your layout folder
...
export const BriefcaseIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
      d="M12 12c1.105 0 2-.895 2-2V7h-4v3c0 1.105.895 2 2 2z"
    />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
      d="M3 7h18M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7M9 7V5a3 3 0 013-3h0a3 3 0 013 3v2"
    />
  </svg>
);
...
export const UserManagementIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
      d="M5.121 17.804A13.937 13.937 0 0112 16c1.21 0 2.385.151 3.5.434M15 10a3 3 0 11-6 0 3 3 0 016 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
      d="M19.428 15.341a2.5 2.5 0 010 3.318M21 18h.01M16.572 15.341a2.5 2.5 0 000 3.318M15 18h-.01" />
  </svg>
);

// MasterIcon - Two Gears
export const MasterIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const UsersCogIcon = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round"
      d="M18 11.25a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zM12.75 17.25a6 6 0 0111.04 2.25H18m-5.25 0H6.75a6 6 0 0111.04-2.25" />
    <path strokeLinecap="round" strokeLinejoin="round"
      d="M9.75 7.5A2.25 2.25 0 115.25 7.5a2.25 2.25 0 014.5 0zM2.25 17.25a6 6 0 0111.04-2.25" />
  </svg>
);

export const Cog6Icon = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round"
      d="M7.5 4.5l1.125 2.438 2.438 1.125L11.063 12l-2.438 1.938L7.5 16.5m9-12l-1.125 2.438-2.438 1.125L12.938 12l2.438 1.938L16.5 16.5" />
