...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen max-h-screen flex flex-col bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50">
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-400 to-cyan-500 p-12 items-center justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 text-white max-w-md">
            <div className="mb-8">
              <h1 className="text-6xl font-bold mb-2">Alfa Agencies</h1>
              <p className="flex items-center gap-3 text-xl teal-50">Pioneer In Life Saving Drugs</p>
            </div>
            
            {/* Features Section */}
            <div className="mt-10">
              <p className="text-white/90 text-lg mb-6">
                Track every order from bill creation to final delivery.
              </p>
              <div className="grid grid-cols-4 gap-2">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-2 flex items-center gap-2 transition-all"
                  >
          ...
          <div className="max-w-md w-full">
            ...
            <div className="lg:hidden mb-8">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Sign In to Alfa Agencies</h2>
                <p className="text-sm text-gray-600">Complete order tracking & management</p>
              </div>
              <div className="flex justify-center gap-3 flex-wrap">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="bg-white border border-teal-200 rounded-lg px-4 py-2 flex items-center gap-2 shadow-sm"
                  >
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="you@alfaagencies.com"
                    />
                  </div>
                  {errors.email && (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
