      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <h1 className="text-2xl font-bold text-gray-800">Billing User Summary</h1>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <ClearFiltersButton onClear={() => { setStartDate(new Date().toISOString().split('T')[0]); setRowsPerPage(20); }} />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          {loading ? (
            ...
            <div className="py-20 text-center text-gray-500">No billing data found</div>
          ) : (
            <>
