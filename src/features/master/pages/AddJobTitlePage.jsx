...
export default function AddJobTitlePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      try {
        const existingJobTitles = JSON.parse(localStorage.getItem('jobTitles') || '[]');
        
        // Check if job title already exists
        if (existingJobTitles.some(job => job.title.toLowerCase() === formData.title.toLowerCase())) {
          setErrors({ title: 'Job title already exists' });
          setLoading(false);
          return;
        }
        ...
        existingJobTitles.push(newJobTitle);
        localStorage.setItem('jobTitles', JSON.stringify(existingJobTitles));
        ...
        setErrors({ general: 'Failed to create job title. Please try again.' });
        setLoading(false);
      }
    }, 500);
  };
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Create a new job title for Alfa Agencies</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Software Engineer, Manager, HR Specialist"
              />
              {errors.title && (
